import { mapQueries, wazeUrl } from "@/lib/maps";
...
export default function WazeLink({ className = "", size = 28 }: WazeLinkProps) {
  return (
    <a
      href={wazeUrl(mapQueries.office)}
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Abrir en Waze — Pitahaya, Cartago"
      className={`inline-flex shrink-0 transition hover:opacity-85 ${className}`}
    >
      <svg
        width={size}
        height={size}
